...
const envSchema = z
  .object({
    ...
    // Full connection string (can be local mongodb:// or Atlas mongodb+srv://)
    MONGODB_URI: z.string().optional().default(''),
    // Or, construct the connection string using separate credentials:
    ...
    // Print OTP directly to terminal console instead of sending email (handy for local development)
    ...
    // Secret key from Chapa Dashboard (Settings -> Webhooks). Optional in dev.
